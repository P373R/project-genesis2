...
<script src="/static/default/jquery-1.5.js" type="text/javascript"></script>
...
<img width="135" height="15" src="bar.php?width=135&amp;type=hp&amp;hp={$player->city->shield}&amp;vitality={$player->city->max_shield}" alt="HP: {$player->city->shield} / {$player->city->max_shield}" /><br />
